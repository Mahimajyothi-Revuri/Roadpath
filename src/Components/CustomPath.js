...
function CustomPath() {
  ...
  const handleDreamJobNavigate = () => {
    if (dreamJob.trim()) {
      navigate(`/dream-job/${encodeURIComponent(dreamJob.trim())}`);
    } else {
      alert('Please enter your dream job before proceeding.');
    }
  };
          ...
          <section>
            ...
            <div className='input-group'>
              ...
              <span className="input-group-text">
                <li><Link to="/goleskill/:job"><button className="arrow-button" onClick={handleDreamJobNavigate}>→</button></Link></li>
              </span>
            </div>
